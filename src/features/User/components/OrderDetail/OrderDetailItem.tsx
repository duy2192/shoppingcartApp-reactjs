...
export function OrderDetailItem({ orderDetailItem, className }: OrderDetailItemProps) {
  return (
    <>
      <tr className={' w-full  border-b border-gray-200 cursor-pointer ' + className}>
        <td scope="row" className="flex items-center py-2 px-1 whitespace-wrap w-full">
          ...
          <p className="font-medium">{orderDetailItem.product.name}</p>
        </td>

        <td className="py-2 px-3 w-1/6 text-center">
          <span className="font-normal text-sm">{getPrice(orderDetailItem.product)}</span>
        </td>

        <td className="py-2 px-3 dark:bg-gray-800 w-1/6 text-center">
          <span className="font-normal text-sm">{orderDetailItem.quantity}</span>
        </td>
        ...
        <td className="py-2 px-3 w-1/6 text-center">
          {getPrice(orderDetailItem.product, orderDetailItem.quantity)}
        </td>
      </tr>
    </>
  );
